...
import com.example.mvvmnewsapp.util.Constans.Companion.QUERY_PAGE_SIZE
            ...
            when(response){
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        val totalPages: Int = newsResponse.totalResults / QUERY_PAGE_SIZE + 2
                ...
                is Resource.Error -> {
                    ...
                    response.message.let { message ->
                        Snackbar.make(view,"An Error has Occured: $message",Snackbar.LENGTH_LONG).show()
                    }
                }
                is Resource.Loading -> {
                    showProgressBar()
